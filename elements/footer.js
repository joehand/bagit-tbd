...
function headerElement (props) {
  return html`
    <footer class="cf bg-moon-gray purple fixed bottom-0 w-100 ph2 pv2 bt b--black-10 black-70">
      <nav class="fr">
      ...
      <p class="link b f3 dim lh-solid">TBD</a>
      <p class="f6 db b lh-solid black-70">BagIt Manufacturing & Shipping</p>
    </footer>
  `
}